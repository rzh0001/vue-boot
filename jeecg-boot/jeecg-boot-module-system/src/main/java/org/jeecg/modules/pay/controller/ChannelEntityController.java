...
public class ChannelEntityController {
	 ...
	 * @return
	 */
	@AutoLog(value = "通道信息-分页列表查询")
	@ApiOperation(value="通道信息-分页列表查询", notes="通道信息-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "通道信息-添加")
	@ApiOperation(value="通道信息-添加", notes="通道信息-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "通道信息-编辑")
	@ApiOperation(value="通道信息-编辑", notes="通道信息-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "通道信息-通过id删除")
	@ApiOperation(value="通道信息-通过id删除", notes="通道信息-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "通道信息-批量删除")
	@ApiOperation(value="通道信息-批量删除", notes="通道信息-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "通道信息-通过id查询")
	@ApiOperation(value="通道信息-通过id查询", notes="通道信息-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      //导出文件名称
      mv.addObject(NormalExcelConstants.FILE_NAME, "通道信息列表");
      mv.addObject(NormalExcelConstants.CLASS, ChannelEntity.class);
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("通道信息列表数据", "导出人:Jeecg", "导出信息"));
