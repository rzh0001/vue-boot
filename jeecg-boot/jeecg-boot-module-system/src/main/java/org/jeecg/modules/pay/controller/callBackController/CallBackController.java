...
public class CallBackController {
    ...
    @RequestMapping(value = "/niuNanAlipay", method = RequestMethod.POST,
    ...
    @RequestMapping(value = "/leTianAlipay", method = RequestMethod.POST,
        produces = "application/x-www-form-urlencoded;charset=UTF-8")
    @ResponseBody
    ...
    @RequestMapping(value = "/antAlipayCallback", method = RequestMethod.POST,
    ...
    @RequestMapping(value = "/gtpaiAlipayCallback", method = RequestMethod.POST,
        produces = "application/json;charset=UTF-8")
    @ResponseBody
