...
@Service
public class CallbackAbroad908Impl extends AbstractCallBack implements InitializingBean {
    @Override
    ...
    public void afterPropertiesSet() throws Exception {
        CallBackServiceFactory.register(BaseConstant.REQUEST_ABROAD_908, this);
    }
}
