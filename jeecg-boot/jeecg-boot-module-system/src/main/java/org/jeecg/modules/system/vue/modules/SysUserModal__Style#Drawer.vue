    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="会员类型(1：代理  2：介绍人 3：商户）">
          <a-input placeholder="请输入会员类型(1：代理  2：介绍人 3：商户）" v-decorator="['memberType', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="谷歌密钥">
          <a-input placeholder="请输入谷歌密钥" v-decorator="['googleSecretKey', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="支付密码">
          <a-input placeholder="请输入支付密码" v-decorator="['paymentPassword', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="IP白名单开关">
          <a-input placeholder="请输入IP白名单开关" v-decorator="['ipSwitch', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'username','realname','password','salt','avatar','sex','email','phone','orgCode','status','delFlag','activitiSync','userId','memberType','upperLimit','lowerLimit','agentId','agentUsername','agentRealname','salesmanId','salesmanUsername','salesmanRealname','googleSecretKey','paymentPassword','ipSwitch'))
		  //时间格式化
