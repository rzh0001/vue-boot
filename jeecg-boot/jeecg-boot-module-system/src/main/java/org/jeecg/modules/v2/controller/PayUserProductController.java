...
public class PayUserProductController {
	...
	public Result<IPage<PayUserProduct>> queryPageList(PayUserProduct payUserProduct,
		...
		QueryWrapper<PayUserProduct> queryWrapper = QueryGenerator.initQueryWrapper(payUserProduct, req.getParameterMap());
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      ...
      for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
          ...
          try {
              List<PayUserProduct> listPayUserProducts = ExcelImportUtil.importExcel(file.getInputStream(), PayUserProduct.class, params);
