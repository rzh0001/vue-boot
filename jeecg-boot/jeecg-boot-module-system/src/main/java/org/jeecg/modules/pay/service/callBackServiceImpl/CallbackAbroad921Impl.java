...
@Service
public class CallbackAbroad921Impl extends AbstractCallBack implements InitializingBean {
    @Override
    ...
    public void afterPropertiesSet() throws Exception {
        CallBackServiceFactory.register(BaseConstant.REQUEST_ABROAD_921, this);
    }
}
