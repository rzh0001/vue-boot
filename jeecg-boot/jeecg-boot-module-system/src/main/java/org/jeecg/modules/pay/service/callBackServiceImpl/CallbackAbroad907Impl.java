...
@Service
public class CallbackAbroad907Impl extends AbstractCallBack implements InitializingBean {
    @Override
    ...
    public void afterPropertiesSet() throws Exception {
        CallBackServiceFactory.register(BaseConstant.REQUEST_ABROAD_907, this);
    }
}
