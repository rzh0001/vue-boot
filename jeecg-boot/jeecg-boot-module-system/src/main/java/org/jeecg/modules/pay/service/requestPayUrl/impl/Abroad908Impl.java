...
@Service
@Slf4j
public class Abroad908Impl implements RequestPayUrl<OrderInfoEntity, String, String, String, String, PayBusiness,
    ...
    public R requestPayUrl(OrderInfoEntity order, String userName, String url, String key, String callbackUrl, PayBusiness userBusiness,HttpServletResponse response) throws Exception {
        Map<String, Object> data = AbroadUtils.buildParamData(getDomain(),BaseConstant.REQUEST_ABROAD_908,userName,order,userBusiness,"908");
    ...
    public void afterPropertiesSet() throws Exception {
        PayServiceFactory.register(BaseConstant.REQUEST_ABROAD_908, this);
    }
}
