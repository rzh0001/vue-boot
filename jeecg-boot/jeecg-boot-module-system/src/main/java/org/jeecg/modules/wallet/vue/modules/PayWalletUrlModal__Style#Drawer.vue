  ...
  export default {
    ...
    data () {
      return {
        ...
        status:{rules: [{ required: true, message: '请输入状态：0：空闲，1：使用中!' }]},
        },
        url: {
          add: "/wallet/payWalletUrl/add",
          edit: "/wallet/payWalletUrl/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'walletUrl','coinType','status'))
		  //时间格式化
        });
