...
public class PayOrderController {
	 ...
	 * @return
	 */
	@AutoLog(value = "代付订单-分页列表查询")
	@ApiOperation(value="代付订单-分页列表查询", notes="代付订单-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "代付订单-添加")
	@ApiOperation(value="代付订单-添加", notes="代付订单-添加")
	@PostMapping(value = "/add")
	public Result<PayOrder> add(@RequestBody PayOrder payOrder) {
	 ...
	 * @return
	 */
	@AutoLog(value = "代付订单-编辑")
	@ApiOperation(value="代付订单-编辑", notes="代付订单-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "代付订单-通过id删除")
	@ApiOperation(value="代付订单-通过id删除", notes="代付订单-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "代付订单-批量删除")
	@ApiOperation(value="代付订单-批量删除", notes="代付订单-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "代付订单-通过id查询")
	@ApiOperation(value="代付订单-通过id查询", notes="代付订单-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      //导出文件名称
      mv.addObject(NormalExcelConstants.FILE_NAME, "代付订单列表");
      mv.addObject(NormalExcelConstants.CLASS, PayOrder.class);
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("代付订单列表数据", "导出人:Jeecg", "导出信息"));
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      ...
      for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
          ...
          try {
              List<PayOrder> listPayOrders = ExcelImportUtil.importExcel(file.getInputStream(), PayOrder.class, params);
