    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="用户登录账号">
          <a-input placeholder="请输入用户登录账号" v-decorator="['username', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="开关(0-关闭;1-开启)">
          <a-input placeholder="请输入开关(0-关闭;1-开启)" v-decorator="['isOpen', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="默认卡(0-否;1-是)">
          <a-input placeholder="请输入默认卡(0-否;1-是)" v-decorator="['isDefault', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
