...
public class UserAmountEntityController {
	...
	public Result<IPage<UserAmountEntity>> queryPageList(UserAmountEntity userAmountEntity,
									  @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
									  @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
									  HttpServletRequest req) {
		Result<IPage<UserAmountEntity>> result = new Result<IPage<UserAmountEntity>>();
		QueryWrapper<UserAmountEntity> queryWrapper = QueryGenerator.initQueryWrapper(userAmountEntity, req.getParameterMap());
	...
	public Result<UserAmountEntity> edit(@RequestBody UserAmountEntity userAmountEntity) {
		Result<UserAmountEntity> result = new Result<UserAmountEntity>();
		UserAmountEntity userAmountEntityEntity = userAmountEntityService.getById(userAmountEntity.getId());
	...
	public Result<UserAmountEntity> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		Result<UserAmountEntity> result = new Result<UserAmountEntity>();
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      ...
      for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
          ...
          try {
              List<UserAmountEntity> listUserAmountEntitys = ExcelImportUtil.importExcel(file.getInputStream(), UserAmountEntity.class, params);
