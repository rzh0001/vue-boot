...
public interface UserChannelEntityMapper extends BaseMapper<UserChannelEntity> {
    ...
    @Select("select c.user_name as userName,c.channel_code as channelCode, b.business_code as businessCode,b.api_key as apiKey,c.upper_limit as upperLimit,c.lower_limit as lowerLimit,b.today_max_amount as todayMaxAmount from sys_user_channel c left join sys_user_business b on c.channel_code = b.channel_code AND c.user_name=b.user_name where c.user_name=#{username}")
