...
public class QueryGenerator {
	...
	public static <T> QueryWrapper<T> initQueryWrapper(T searchObj, Map<String, String[]> parameterMap) {
		return initQueryWrapper(searchObj, parameterMap, true);
	}

	// 增加是否排序参数 ruanzh
	public static <T> QueryWrapper<T> initQueryWrapper(T searchObj, Map<String, String[]> parameterMap, boolean ifOrder) {
		long start = System.currentTimeMillis();
		QueryWrapper<T> queryWrapper = new QueryWrapper<T>();
		installMplus(queryWrapper, searchObj, parameterMap, ifOrder);
	 ...
	 */
	public static void installMplus(QueryWrapper<?> queryWrapper, Object searchObj, Map<String, String[]> parameterMap, boolean ifOrder) {
		...
		*/
		...
		// 排序逻辑 处理 
		doMultiFieldsOrder(queryWrapper, parameterMap, ifOrder);
	...
	//多字段排序 TODO 需要修改前端
	public static void doMultiFieldsOrder(QueryWrapper<?> queryWrapper, Map<String, String[]> parameterMap, boolean ifOrder) {
