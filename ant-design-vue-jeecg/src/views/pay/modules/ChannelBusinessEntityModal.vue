    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="加密密钥">
          <a-input placeholder="请输入加密密钥" v-decorator="['apiKey', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="商户">
          <a-input placeholder="请输入商户" v-decorator="['businessCode', validatorRules.businessCode]" />
        </a-form-item>
...
<script>
  ...
  export default {
    name: "ChannelBusinessEntityModal",
    data () {
      return {
        title:"操作",
        channels: [],
