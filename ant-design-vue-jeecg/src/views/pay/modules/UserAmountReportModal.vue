...
<!--          :wrapperCol="wrapperCol"-->
<!--          label="期初金额">-->
<!--          <a-input-number v-decorator="[ 'originalamount', {}]" />-->
<!--        </a-form-item>-->
<!--        <a-form-item-->
<!--          :labelCol="labelCol"-->
<!--          :wrapperCol="wrapperCol"-->
...
<!--          :wrapperCol="wrapperCol"-->
<!--          label="今日入金">-->
<!--          <a-input-number v-decorator="[ 'paidAmount', {}]" />-->
<!--        </a-form-item>-->
<!--        <a-form-item-->
<!--          :labelCol="labelCol"-->
<!--          :wrapperCol="wrapperCol"-->
<!--          label="今日下发">-->
<!--          <a-input-number v-decorator="[ 'cashOutAmount', {}]" />-->
<!--        </a-form-item>-->
<!--        <a-form-item-->
<!--          :labelCol="labelCol"-->
<!--          :wrapperCol="wrapperCol"-->
...
<!--          :wrapperCol="wrapperCol"-->
<!--          label="通道手续费">-->
<!--          <a-input-number v-decorator="[ 'payFee', {}]" />-->
<!--        </a-form-item>-->
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'userId','userName','reportDate','originalamount','payType','paidAmount','cashOutAmount','availableAmount','payFee','agentId','agentUsername','agentRealname','salesmanId','salesmanUsername','salesmanRealname'))
		  //时间格式化
        });
