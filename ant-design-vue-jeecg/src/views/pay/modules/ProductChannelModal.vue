  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/productChannel/productChannel/add",
          edit: "/productChannel/productChannel/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'channelCode','channelName','createUser','productCode','productName','status','updateUser'))
		  //时间格式化
        });
