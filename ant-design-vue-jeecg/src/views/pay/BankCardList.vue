          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="分支行">
                <a-input placeholder="请输入分支行" v-model="queryParam.branchName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
...
<!--          </a-dropdown>-->
    ...
    <!-- 表单区域 -->
    <bankCard-modal ref="modalForm" @ok="modalFormOk"></bankCard-modal>
  </a-card>
</template>

<script>
  import BankCardModal from './modules/BankCardModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/pay/bankCard/list',
          delete: '/pay/bankCard/delete',
          deleteBatch: '/pay/bankCard/deleteBatch',
          exportXlsUrl: 'pay/bankCard/exportXls',
          importExcelUrl: 'pay/bankCard/importExcel'
        }
      }
    },
    computed: {
