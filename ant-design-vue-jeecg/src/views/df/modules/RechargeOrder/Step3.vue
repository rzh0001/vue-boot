<template>
  <div>
    <a-form style="margin: 40px auto 0;">
      <result title="操作成功" :is-success="true" description="请等待客服确认">
        <div class="information">
          <a-row>
            <a-col :sm="8" :xs="24">充值订单号：</a-col>
            <a-col :sm="16" :xs="24">{{order.orderId}}</a-col>
          </a-row>
<!--          <a-row>-->
...
<!--          </a-row>-->
          <a-row>
            ...
            <a-col :sm="16" :xs="24"><span class="money">{{order.amount}}</span> 元</a-col>
          </a-row>
        </div>
        <div slot="action">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toOrderList () {
        this.$router.push('/df/RechargeOrder')
      }
    }
  }
</script>
